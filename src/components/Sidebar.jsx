...
const Sidebar = () => {
  ...
  <>
    ...
    <div className={`absolute top-0 h-screen w-2/3 bg-gradient-to-tl from-white/10 to-[#20201f] backdrop-blur-lg z-10 p-6 md:hidden smooth-transition ${mobileMenuOpen ? 'left-0' : '-left-full'}`}>
      <img src={Logo} alt="logo" className="w-full h-44 object-contain" />
